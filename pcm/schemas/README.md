...
The PCM v2 / IPC v1 files are unmodified, vendored JSON schemas from the installed **KiCad 10.0.4** distribution
...
`pcm.v1.schema.json` is additionally captured from **KiCad 6.0.11** on **2026-09-06**,
so unified packages and online repository indexes are validated against the oldest supported PCM
version as well as PCM v2. The IPC manifest is also checked against API v1.
...
|---|---|---|
| `pcm.v1.schema.json` | `https://go.kicad.org/pcm/schemas/v1` | `c11de0c4432cb63c88c55a54f2b5830b54bdd81d86d5eeb84149fa475f886bcb` |
